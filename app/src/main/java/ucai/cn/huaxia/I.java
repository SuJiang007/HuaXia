...
public interface I {
     ...
     * 下载用户头像的请求
     */
    String REQUEST_DOWNLOAD_AVATAR_USER = HuaXiaApplication.SERVER_ROOT + "?" + KEY_REQUEST + "="
     ...
     * 下载商品相册图像的URL
     */
    String DOWNLOAD_AVATAR_URL = HuaXiaApplication.SERVER_ROOT +
     ...
     * 下载商品相册图像的接口
     */
    String DOWNLOAD_ALBUM_IMG_URL = HuaXiaApplication.SERVER_ROOT +
     ...
     * 下载精选首页图像的接口
     */
    String DOWNLOAD_BOUTIQUE_IMG_URL = HuaXiaApplication.SERVER_ROOT +
     ...
     * 下载收藏商品图像的接口
     */
    String DOWNLOAD_GOODS_THUMB_URL = HuaXiaApplication.SERVER_ROOT +
     ...
     * 壹收款服务端支付URL
     */
    String PAY_URL = HuaXiaApplication.SERVER_ROOT + "?request=" + I.REQUEST_PAY;
}
